...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "X") {
            ...
            select.style.backgroundImage  = 'url("./Media/XIcon.png")'
            select.style.backgroundSize = 'contain';
            select.style.backgroundRepeat = 'no-repeat';
            select.style.backgroundPosition = 'center';
        }  else {
            //Active player may only be "X" or "O" so, if not "X" it must be "O"
            select.style.backgroundImage = 'url("./Media/OIcon.png")'
            select.style.backgroundSize = 'contain';
            select.style.backgroundRepeat = 'no-repeat';
            select.style.backgroundPosition = 'center';
        }
        ...
        audio('./Media/movesound.wav');
        //This condition checks to see if it is the computer's turn
        if (activePlayer === 'O') {
            //This function disables clicking for computer turn.
            disableClick();
            //This function wait 1 second before the computer places an image and enables click.
